    ...
    return (
        <Router basename={base === "/" || "http://localhost:3000/" ? "/" :`/${base}`}>
            <Routes>
                ...
                <Route path="/borrow_book/:bookId" element={<Template userT={userT} page="Emprunter un livre"><BorrowBook /></Template>} />
                <Route path="/borrow_history" element={<Template userT={userT} page="Historique des emprunts"><BorrowHistory /></Template>} />
                <Route path="/return_book/:bookId" element={<Template userT={userT} page="Retourner un livre"><ReturnBook /></Template>} />
            </Routes>
        </Router>
    );
}
